...
//        pulseAnimation.fromValue = NSValue(cgRect: CGRect(x: bounds.origin.x, y: bounds.origin.y, width: frame.size.width, height: frame.size.height))
//        pulseAnimation.toValue = NSValue(cgRect: CGRect(x: bounds.origin.x, y: bounds.origin.y, width: frame.size.width + 10, height: frame.size.height + 10))
